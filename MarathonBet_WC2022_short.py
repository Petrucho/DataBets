...
# ЧМ 2022
driver.get("https://www.marathonbet.ru/su/popular/Football/Internationals+-+4410142")
...
try:    
    ...
    driver.save_screenshot('MarathonBet_world_cup_2022.png')

    xp_block = '//*[@id="category13372800"]/div/div'
    ...
    # splitted_list = split_div_MarathonBet.split_list(block_name_list) # split List
    # save_to_csv.save_to_file(splitted_list, 'MarathonBet') # splitted List saving to csv-file
